...
import threading
pswrd = "pstrxion"
key = "utfc-7195-krtp-1850-bawl-9922"
servisler_sms = []
...
while 1:
    system("cls||clear")
    print("""{}
 ____  ____ _____ ____  __  _____ ___  _   _ 
|  _ \/ ___|_   _|  _ \ \ \/ /_ _/ _ \| \ | |
| |_) \___ \ | | | |_) | \  / | | | | |  \| |
|  __/ ___) || | |  _ <  /  \ | | |_| | |\  |
|_|   |____/ |_| |_| \_\/_/\_\___\___/|_| \_|        
        Sms: {}           {}by {}@PSTRXION insta:@pstrxion.inc\n  
    ...
    while True:
        keyg = input("Key Giriniz:")
        if keyg == key:
    	    break
    	else :
    		print("Hata!Yanlış Key :/") 		
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- SMS Gönder (Yavaş)\n\n 2- SMS Gönder (Hızlı)\n\n 3- Çıkış\n\n" + Fore.LIGHTYELLOW_EX + " Lütfen Seçim Yapın: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
    ...
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Telefon numarasını giriniz:+90"+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + f"SmS Miktarı Giriniz {sonsuz}: "+ Fore.LIGHTGREEN_EX, end="")
            kere = input()
            if kere:
                kere = int(kere)
            else:
